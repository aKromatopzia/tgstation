...
/obj/effect/decal/cleanable/vital/robotic/oil/attackby(obj/item/I, mob/living/user)
...
/obj/effect/decal/cleanable/vital/robotic/oil/fire_act(exposed_temperature, exposed_volume)
